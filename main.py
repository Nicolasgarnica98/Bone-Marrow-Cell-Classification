...
def main():
    ...
    if os.path.exists('./dataset/train') == False:
        ...
        print(get_dataset.count_classes(df_img=df_img,df_labels= df_lbl))
    ...
    #     get_dataset.count_classes(df_img=df_train, df_labels=df_lbl)
    #     print('\n Val')
    #     get_dataset.count_classes(df_img=df_val, df_labels=df_lbl)
