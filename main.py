...
def main():
    ...
    #Train pipeline
    def train_pipeline(train_data, lbl_train, val_data, lbl_val, selected_model=None):
    ...
    #Get predictions
    test_img_array = get_dataset.load_images(df_img_test,'test images')
    ...
    with tf.device('/CPU:0'):
        actual_model.model_prediction(pp_test_img_array,df_lbl_test,df_lbl)
